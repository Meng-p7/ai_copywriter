...
### v1.1.1 (2026-02-27)
- 🏗️ 架构升级：拆分前端代码，优化项目结构
- 🎬 新增视频生成功能：支持Seedance 2.0/1.8模型生成数字人视频(测试中)
- 💎 新增会员系统：9.9元/月，包含10次2.0和25次1.8使用次数
- 🎨 UI优化：统一模态框设计，修复双滚动条问题
- 📦 代码重构：优化前端交互逻辑，提升用户体验
- 🐛 Bug修复：修复文档模态框全屏显示问题

### v1.1.0 (2026-02-25)
- ✨ 新增"再次生成"功能：生成文案后，按钮变为"不满意？点击再次生成"，用户可重新生成
- 🎨 优化按钮交互：修改创作场景、风格、时长或核心信息时，按钮自动恢复为"生成文案"
- 🎯 UI一致性改进：历史记录和收藏模态框保持统一设计
- 📦 创作场景扩展：新增文旅探店、本地生活团购两大场景
